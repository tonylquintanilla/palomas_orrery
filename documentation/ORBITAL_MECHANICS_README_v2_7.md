...
**Last Updated:** January 31, 2026 (v2.7 - Orcus-Vanth JPL Orbit Resolution)  
...
| Orcus-Vanth | Horizons (derived) | JPL satellite solution |
...
| System | Barycenter | Primary | Secondary |
|--------|-----------|---------|-----------|
| Patroclus-Menoetius | `20000617` | `920000617` | `120000617` |
| Orcus-Vanth | `20090482` | `920090482` | `120090482` |
| Eurybates-Queta | `20003548` | `920003548` | `120003548` (untested) |
| Polymele-Shaun | `20015094` | `920015094` | `120015094` (untested) |
...
**Document Version:** 2.7 (Orcus-Vanth JPL Orbit Resolution)  
**Date:** January 31, 2026  
**Maintained By:** Tony  
**Contributors:** Claude (AI assistant)

*"Can't query the primary? Derive it from the secondary. The physics doesn't care about the API."*
