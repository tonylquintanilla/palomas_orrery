# Working Protocol v2.2: Tony & Claude
...
## File Migration & Refactoring Best Practices
...
**For irreplaceable data files:**
1. **Update code paths FIRST**
2. **Test with files in original location** (should fail gracefully)
3. **Verify code looking in new location**
4. **Then move files**
5. **Test again with files in new location**
...
**If files appear in BOTH locations → Incomplete migration! Investigate before proceeding.**
...
### Signs You Need Comprehensive Search
