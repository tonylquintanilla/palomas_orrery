...
Tony Quintanilla, PE | Claude | v3.57 | September 11, 2026

Cut from 1fa413d9 at https://github.com/tonylquintanilla/palomas_orrery
...
orrery-coding-conventions    1.8  Markers, hover text, axes, shells,
...
provenance-discipline        2.11 Scanner runs, audits, citations, constants,
...
ledger-and-session-records   1.11 Ledger edits, ledger_index.py, RICE,
...
gallery-cache-builder        1.4  Nightly builder, atomic swap, coverage_index,
                                  ...
                                  layers
interactive-exhibit          1.2  adding or changing an exhibit in
