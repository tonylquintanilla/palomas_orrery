...
## Tony with Claude | v3.18 | April 10, 2026
...
**Established:** April 2026 for solar shells (`solar_visualization_shells.py`) and MAPS ghost tail (`comet_visualization_shells.py`). Apply to all new shells and multi-segment traces going forward.
...
*"Napoleon with his ulcer flaring, despondent, seeing disaster. Ney clueless. The Imperial Guard retreats."* - Tony, on why Waterloo is the right vehicle for the experiment, Apr 3, 2026
...
*"It's like an experimental probe into the solar atmosphere."* - Tony, on MAPS, Apr 9, 2026
...
- Schwarzschild precession: 3piRs / (a*(1-e^2)) radians per orbit
...
- Auto-detect text color from background brightness: ITU-R BT.601 formula (r299 + g587 + b*114) / 1000
...
*~870 lines. Functional for Claude, readable for human, signal preserved.*
