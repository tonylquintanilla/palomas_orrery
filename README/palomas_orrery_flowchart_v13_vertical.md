flowchart TD
    ...
    subgraph SOURCES["🌐 EXTERNAL DATA SOURCES"]
        direction LR
        HORIZONS{{"JPL Horizons<br/>Orbits"}}
    ...
    subgraph CACHE["💾 CACHE MANAGEMENT LAYER"]
        direction TB
        subgraph ORBIT_CACHE["Orbit Cache"]
            ORBITCACHE[("orbit_cache/<br/>JSON files")]
    ...
    subgraph PROCESS["⚙️ DATA PROCESSING LAYER"]
        ...
        subgraph ORBIT_PROC["Orbital Mechanics"]
            REFINED["refined_orbits.py<br/>RefinedOrbitSystem"]
            IDEALIZED["idealized_orbits.py<br/>Keplerian orbits"]
            INTEGRATION["orrery_integration.py<br/>OrreryConfiguration"]
            APSIDAL["apsidal_markers.py<br/>perihelion/aphelion"]
        end
    ...
    subgraph GUI["🖥️ USER INTERFACE LAYER"]
        ...
        subgraph MAIN_GUI["Main Application"]
            ORRERY["palomas_orrery.py<br/>Main GUI (404KB, 8,289 lines)<br/>plot_objects(), animate_objects()"]
        end
