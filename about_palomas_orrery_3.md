...
**Computational Validation**: The models incorporate results from N-body simulations showing how the original spherical population has been sculpted into the structured system we observe today.
