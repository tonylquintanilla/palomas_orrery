<!-- Doc-Kind: zoned | The running ledger: every open and closed item under a stable handle, with the decisions behind it. Carries a generated INDEX. -->
...
|  | L-272 | The gallery repo had no README | DONE | 5.7 | 2026-09-01 |
...
|  | L-168 | propagate_marker uses solar K_GAUSS mean-motion -- wrong for planetocentric moon markers (FLAG-2; caught in F1 design, avoided in serving, fixed at source 2026-09-09) | DONE | 3.6 | 2026-09-10 |
...
#### [L-256] provenance-discipline 2.8, and the status pass it enables
...
- **AMENDED 2026-08-30: the diagnosis above is wrong, and the bullets
...
#### [L-269] A report names its items, not how many there are
...
- **A museum lands you in an entrance hall.** Seven proposals, Tony:
  "I like your ideas."
  1. THE LOBBY. First screen: the name, one sentence, the doors, What's
...
<!-- L:272 status:DONE upd:2026-09-01 section:C flag: rice:3/2/95/1 -->
...
<!-- L:274 status:DONE upd:2026-09-01 section:C flag: rice:3/3/95/2 -->
...
<!-- L:276 status:DONE upd:2026-09-03 section:C flag: rice:3/3/95/1 -->
...
- **Closed 2026-09-03 by `patch_L276_mode7_repo_access.py`**, protocol
...
<!-- L:280 status:DONE upd:2026-09-04 section:C flag: rice:4/4/80/3 -->
...
**Gap:** none -- move to section C. Scope carried by L-282 and L-286.
