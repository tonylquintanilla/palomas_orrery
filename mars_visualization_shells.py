...
# Cross-checked: Claude 2026-08-01 -- MAVEN data (worksheet_claude_mars_visualization.md)
# Cross-checked: GPT 2026-08-01 -- NASA MAVEN (track1_gpt_independent_worksheet_mars_visualization.md)
...
def create_mars_magnetosphere_shell(center_position=(0, 0, 0), sun_position=(0, 0, 0)):
    ...
    magnetosphere_text = [
                            ...
                            "   but it's much closer to the planet (around 1.6 Mars radii).<br>"
    ...
    bow_shock_text = ["Mars Bow Shock: Forms where the supersonic solar wind first encounters<br>"
                "Mars' atmosphere and ionosphere. It's much closer to Mars (around 1.6 Mars radii)<br>"
    ...
    for i in range(n_anomalies):
        ...
        # Info marker only on first iteration
        if i == 0:
            traces.append(create_info_marker(
...
# Cross-checked: Claude 2026-08-01 -- NASA NSSDCA Mars Fact Sheet (worksheet_claude_mars_visualization.md)
# Cross-checked: GPT 2026-08-01 -- JPL SSD astrodynamic parameters (track1_gpt_independent_worksheet_mars_visualization.md)
...
def create_mars_hill_sphere_shell(center_position=(0, 0, 0)):
    ...
    layer_info = {
        ...
        'description': (
                ...
                "  1.1 million kilometers (about 0.007 AU).<br>" 
