...
HOMININ_SPECIES = [
    ...
    {'name': 'Sahelanthropus tchadensis', 'age_ma': 7.0, 'category': 'early_hominin', 'evidence': 'fossil',
     'y_offset': 0.0,
     'note': 'Oldest possible hominin ("Toumaï").<br>Chad, 7.2-6.8 Ma.<br>Debated bipedality.<br><i>Source: Brunet et al. 2002, Nature</i>'},
    ...
    {'name': 'Homo heidelbergensis', 'age_ma': 0.7, 'category': 'homo', 'evidence': 'fossil',
     'y_offset': 0.0,
     'note': '⚠️ STATUS REVISED (2025): May be specialized<br>side-branch, not direct ancestor of sapiens.<br>Europe/Africa. 700-200 ka.<br>New divergence dates push common ancestors<br>back to >1 Ma, before heidelbergensis existed.<br><i>Source: Feng et al. 2025, Science; Stringer</i>'},
    ...
    {'name': 'Homo longi', 'age_ma': 1.0, 'category': 'homo', 'evidence': 'fossil',
     ...
     'note': '🆕 "Dragon Man" clade (named 2021).<br>Yunxian 2 skull (1 Ma) is earliest member.<br>Diverged from sapiens lineage ~1.32 Ma.<br>Includes Denisovans as late members.<br>Sister group to H. sapiens, not Neanderthals.<br><i>Source: Feng et al. 2025, Science</i>'},
    ...
    {'name': 'Homo floresiensis', 'age_ma': 0.19, 'category': 'homo', 'evidence': 'fossil',
     ...
     'note': '🏝️ "The Hobbit" of Flores, Indonesia.<br>~1m tall — island dwarfism or ancient lineage?<br>Survived until ~50 ka — COEXISTED with sapiens!<br>Sophisticated tools despite small brain.<br>190-50 ka (Liang Bua cave).<br><i>Source: Brown et al. 2004, Nature</i>'},
    {'name': 'Homo luzonensis', 'age_ma': 0.067, 'category': 'homo', 'evidence': 'fossil',
     'y_offset': 0.0,  # Isolated in time, no stagger needed
     'note': '🏝️ Philippines hominin (discovered 2019).<br>Callao Cave, Luzon. Small-bodied like floresiensis.<br>Mix of primitive and modern features.<br>Parallel island evolution — "Island Rule."<br>~67 ka — also coexisted with sapiens.<br><i>Source: Détroit et al. 2019, Nature</i>'},
    ...
    {'name': '"Superarchaic" Ghost', 'age_ma': 2.0, 'category': 'ghost', 'evidence': 'dna_only',
     ...
     'note': '👻 GHOST POPULATION (no fossils recovered)<br>Detected via DNA signatures in Denisovans.<br>Split from human lineage 2.2-1.8 Ma.<br>Possibly late H. erectus populations in Asia.<br>Contributed DNA to Neanderthal-Denisovan ancestor.<br><i>Source: Rogers et al. 2020, Science Advances</i>'},
    {'name': 'West African Ghost', 'age_ma': 0.7, 'category': 'ghost', 'evidence': 'dna_only',
     'y_offset': 0.7,  # Stagger from heidelbergensis
     'note': '👻 GHOST POPULATION (no fossils recovered)<br>Detected in Yoruba, Mende, other West Africans.<br>2-19% of ancestry from unknown archaic hominin.<br>Split 360 ka - 1.02 Ma; introgressed 0-124 ka.<br>Genes enriched for tumor suppression, hormones.<br><i>Source: Durvasula & Sankararaman 2020,<br>Science Advances</i>'},
    {'name': 'Population A (80%)', 'age_ma': 1.5, 'category': 'ghost', 'evidence': 'dna_only',
     'y_offset': 0.0,
     'note': '👻 GHOST POPULATION (no fossils recovered)<br>🆕 Major ancestor of H. sapiens (80% of genome).<br>Split from Population B ~1.5 Ma in Africa.<br>Severe bottleneck after split, then slow growth.<br>Also ancestral to Neanderthals and Denisovans.<br>Merged with Pop. B ~300 ka to form sapiens.<br><i>Source: Cousins et al. 2025, Nature Genetics</i>'},
    {'name': 'Population B (20%)', 'age_ma': 1.5, 'category': 'ghost', 'evidence': 'dna_only',
     'y_offset': 0.7,  # Stagger from Pop A (same age!)
     'note': '👻 GHOST POPULATION (no fossils recovered)<br>🆕 Minor ancestor of H. sapiens (20% of genome).<br>Split from Population A ~1.5 Ma in Africa.<br>Genes concentrated in brain function and<br>neural processing—may have been crucial<br>for cognitive evolution.<br>Merged with Pop. A ~300 ka to form sapiens.<br><i>Source: Cousins et al. 2025, Nature Genetics</i>'},
    ...
    {'name': '"Deep Denisovan" (D2)', 'age_ma': 0.28, 'category': 'ghost', 'evidence': 'dna_only',
     ...
     'note': '👻 GHOST POPULATION (no fossils recovered)<br>🌏 Deeply divergent Denisovan lineage.<br>Split from Altai Denisovans ~280 ka.<br>Detected in Papuans, Filipinos (up to 4%).<br>Suggests multiple Denisovan populations across<br>SE Asia, not just Siberian group.<br><i>Source: Jacobs et al. 2019, Cell</i>'},
    {'name': 'SE Asian Archaic Ghost', 'age_ma': 0.15, 'category': 'ghost', 'evidence': 'dna_only',
     'y_offset': 0.0,  # Stagger from floresiensis
     'note': '👻 GHOST POPULATION (no fossils recovered)<br>🌏 Unknown archaic detected in SE Asians.<br>More divergent than Denisovans — possibly<br>from H. erectus descendants or floresiensis-<br>related populations. Controversial but intriguing.<br>May explain unique adaptations in region.<br><i>Source: Teixeira et al. 2021; Mondal et al. 2019</i>'},
]
...
MIS_STAGES = [
    ...
    {'name': 'MIS 4', 'start_ma': 0.071, 'end_ma': 0.057, 'type': 'cold',
     'note': 'Glacial period<br>⚠️ TOBA SUPERERUPTION (~74 ka)<br>Possible population bottleneck.<br>Volcanic winter, 6-10 year impact.'},
    ...
    {'name': 'MIS 5e', 'start_ma': 0.130, 'end_ma': 0.115, 'type': 'warm',
     'note': '🌍 EEMIAN INTERGLACIAL<br>Last time as warm as today (naturally).<br>"Green Sahara" - corridor OPEN.<br>First major H. sapiens expansion.<br>Hippos in the Thames, lions in Alaska.'},
    
    # Deeper time
    {'name': 'MIS 6', 'start_ma': 0.191, 'end_ma': 0.130, 'type': 'cold',
     'note': '❄️ PENULTIMATE GLACIAL<br>Severe cold; Sahara impassable.<br>Populations isolated in refugia.<br>May have triggered 80/20 ghost split<br>that later formed H. sapiens.'},
    ...
    {'name': 'MIS 11', 'start_ma': 0.424, 'end_ma': 0.374, 'type': 'warm',
     'note': '🌡️ SUPER-INTERGLACIAL<br>Longest warm period of Pleistocene.<br>~50,000 years of warmth.<br>H. heidelbergensis flourishing.<br>Best analog for future climate?'},
...
CLIMATE_EVENTS = [
    {'name': 'Toba Supereruption', 'age_ma': 0.074, 'type': 'catastrophe',
     'note': '🌋 TOBA SUPERERUPTION (~74 ka)<br>Largest eruption in 2 million years.<br>Volcanic Explosivity Index 8.<br>6-10 year volcanic winter.<br>Proposed genetic bottleneck in humans<br>(debated but significant).<br><i>Source: Ambrose 1998; Rampino & Self 1992</i>'},
    {'name': 'Green Sahara (MIS 5e)', 'age_ma': 0.125, 'type': 'corridor',
     'note': '🌿 GREEN SAHARA WINDOW<br>Sahara transforms to grassland/lakes.<br>Migration corridor OPEN.<br>H. sapiens expands into Levant.<br>First wave Out of Africa.<br><i>Source: Drake et al. 2011</i>'},
    {'name': 'Green Sahara (Holocene)', 'age_ma': 0.009, 'type': 'corridor',
     'note': '🌿 AFRICAN HUMID PERIOD<br>Sahara green again (~11-5 ka).<br>Lakes, rivers, human settlements.<br>Cattle herding, rock art.<br>Ended ~5,500 ya → desertification.<br><i>Source: deMenocal et al. 2000</i>'},
]
