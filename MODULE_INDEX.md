...
**Total Lines of Code (non-blank):** 104,856  
...
- `patch_L291_1_earth_exhibit_constants.py`
...
| Module | Description |
|--------|-------------|
| `patch_L291_1_earth_exhibit_constants.py` | - Earth exhibit constants (L-291, step 2) (212 lines) |
