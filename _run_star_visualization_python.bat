@echo off
REM ================================================================
REM  PALOMA'S ORRERY - STAR VISUALIZATION LAUNCHER
REM ================================================================
...
REM  
REM  Description:
REM    Launches the Star Visualization GUI from Python source.
...
echo.
echo ============================================================
echo     PALOMA'S ORRERY - Star Visualization
echo ============================================================
...
REM Check if star_visualization_gui.py exists
if not exist "%SCRIPT_DIR%star_visualization_gui.py" (
    echo ERROR: star_visualization_gui.py not found!
    echo.
    echo Please ensure this batch file is in the same 
    echo directory as star_visualization_gui.py
    echo.
...
if %errorlevel% neq 0 (
    ...
    echo.
    echo ============================================================
    echo     Star Visualization closed successfully
    echo ============================================================
    echo.
    timeout /t 3
)
