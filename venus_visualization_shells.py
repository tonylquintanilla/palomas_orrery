...
def create_venus_magnetosphere_shell(center_position=(0, 0, 0), sun_position=(0, 0, 0)):
    ...
    magnetosphere_text = ["Venus has no internal magnetic field. Its weak, induced magnetosphere forms where the solar wind <br>"
            ...
            "Extent (Venus radii, R_V):<br>"
            "* Bow shock (dayside): ~1.3 - 1.7 R_V from center. Points sunward along +X; XY plane is the ecliptic.<br>"
            "* Magnetopause (dayside): ~1.05 - 1.1 R_V; pushed inward under high solar-wind pressure.<br>"
            "* Magnetotail (nightside): tens of R_V, reaching ~45 - 60 R_V under active conditions."]
