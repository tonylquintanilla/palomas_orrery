...
#   status:       completed | planned | ongoing |canceled
...
# ========================================================================
    ...
    'Psyche': [
        ...
        # Date: 2026-05-05 21:06
        # Source file: C:/Users/tonyq/OneDrive/Desktop/python_work/palomas_orrery_images/Mars_system_static_psyche_gravitational_assist.html
        # Add to SPACECRAFT_ENCOUNTERS['Psyche'] list:
        {
            ...
            'dist_au': 8009 / AU_KM, 
            'v_kms': 5.51,
            'label': 'Mars Gravitational Assist Static',
        ...
        # Source file: C:/Users/tonyq/OneDrive/Desktop/python_work/palomas_orrery_images/Mars_system_animation_psyche_flyby_shells.html
        # Add to SPACECRAFT_ENCOUNTERS['Psyche'] list:
        {
            'target': 'Mars',
            'date': '2026-5-15 9:28',
            ...
            'dist_au': 8009 / AU_KM,  
            'v_kms': 5.51,
            'label': 'Mars Gravitational Assist Animated',
            'note': ('Psyche will use Mars\' gravity to increase its speed in its voyage towards asteroid 16 Psyche. It also will use the encounter to test its instruments.'),
            'status': 'ongoing',
            'source': 'NASA/JPL',
            'date_source': 'horizons',
            'center': 'Mars',
            'select_also': ['Mars', 'Phobos', 'Deimos'],
            'plot_days': 1,  # TODO: adjust
            'plot_scale_au': 0.0003,
        },
        ...
        # Source file: C:/Users/tonyq/OneDrive/Desktop/python_work/palomas_orrery_images/Mars_system_animation_psyche_phobos_flyby.html
        # Add to SPACECRAFT_ENCOUNTERS['Psyche'] list:
        {
            'target': 'Phobos',
            'date': '2026-05-15 9:51',
            'type': 'flyby',
            'dist_km': 1151,        
            'dist_au': 1151 / AU_KM,  # 7.61 e-6 au
            'v_kms': 6.4,
            'label': 'Flyby of Phobos Animated',
            'note': ('The Phobos flyby will be a change to test Psyche\'s instruments and measurements before the 16 Psyche arrival.'),
            'status': 'ongoing',
            'source': 'NASA/JPL',
            'date_source': 'horizons',
            'center': 'Phobos',
            'select_also': ['Phobos', 'Mars', 'Deimos'],
            'plot_days': 1,  # TODO: adjust
            'plot_scale_au': 0.0003,
        },
...
# Generated by Gallery Studio encounter export
# Date: 2026-05-02 20:49
# Source file: C:/Users/tonyq/OneDrive/Desktop/python_work/palomas_orrery_images/16_psyche_20231014_0000.html
# Add to SPACECRAFT_FULL_MISSION dict:
    'Psyche': {
        'center': 'Sun',
