...
agentic-pre-test             1.0  BEFORE delivering complete files/agentic
                                  code; after data-content sweeps
horizons-orbital-mechanics   1.0  Horizons queries, centers, frames,
                                  osculating elements, encounters
provenance-discipline        1.0  Scanner runs, audits, citations,
                                  constants, pre-push (Tier-1 = 0)
earth-system-pipeline        1.0  KMZ layers, ERA5/ERDDAP/IPC, scenarios,
                                  ANY human-cost visualization or text
gallery-pipeline             1.0  Gallery Studio, json_converter,
                                  index.html viewer, gallery cards
...
Gallery work has its own repo (tonyquintanilla.github.io) -- pin each repo's
SHA separately.
